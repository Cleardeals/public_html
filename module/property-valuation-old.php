...
//print_r($property_details);
		...
		if(!empty($predictedPrice)){
			$price_comparison_img = file_get_contents(HTACCESS_URL.'calc/property-chart.png'); 
  ...
  <header class="masthead2">
    <div class="container text-center">
      ...
      <form method="post" action="<?=HTACCESS_URL?>property-valuation-new/" id="accForm" onsubmit="return chklocation();">
        ...
        <div class="search-div">
            <div class="row m-0">
              <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                <div class="input-group boder1">
                  <label for="furnishing" style="line-height:53px;" class="form-control bg-transparent border-right rounded-0">City:</label>
                </div>
              </div>
        ...
        <div class="search-div">
          ...
          <div class="search-div">
            <div class="row m-0">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 p-0 boder2" id="demo" style="height:66px">
                <select id="Area" name="area" class="form-control bg-transparent border-0">
      ...
      <div class="search-div" style="min-height:800px; padding:20px; text-align:left;">
        <div class="row m-0">
          <div class="col-lg-12 col-md-12 col-sm-12 p-0">
            <p>Property Value: Rs <?=round($predictedPrice)?>
              <br/>
            </p>
      ...
      <div class="search-div" style="min-height:800px; padding:20px; text-align:left;">
        <div class="row m-0">
          <div class="col-lg-12 col-md-12 col-sm-12 p-0">
            <p>Property Value: Rs<?=round($predictedbungalowPrice)?><br/></p>
...
(function($) {
	...
	$.ajax({
			url:'<?=HTACCESS_URL.'calculatorController.php?mode=getcity'?>',
			...
			success: function(response) {
				alert(response);
            // Assuming response is a JSON array of cities
            try {
                // Parse the response if it's not already an object (if the backend sends a JSON string)
                var country = [response];

                // Initialize select2 dropdown with the response data
                $("#area").select2({
                    data: country,
