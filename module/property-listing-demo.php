...
<div class="center-section-in">
  <div class="container">
    <div>
      <ul id="property-tab" role="tablist" class="nav nav-tabs nav-pills flex-column flex-sm-row text-center bg-light border-0 rounded-nav">
        <li class="nav-item flex-sm-fill"> <a id="home-tab" href="<?=HTACCESS_URL?>property-listing/"  class="nav-link border-0 text-uppercase font-weight-bold active btn">For Sale</a> </li>
        <li class="nav-item flex-sm-fill"> <a id="profile-tab"  href="<?=HTACCESS_URL?>for-rent/" class="nav-link border-0 text-uppercase font-weight-bold btn">For rent</a> </li>
      </ul>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-6 wow fadeIn">
        <div class="properties-div">
          ...
          <div class="properties-name">
            ...
            <p><i class="fa fa-map-marker" aria-hidden="true"></i> Ambawadi, Ahmedabad <a href="<?=HTACCESS_URL?>property-detail/" class="btn">More details</a></p>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 wow fadeIn">
        <div class="properties-div">
          <div class="img-pro"><a data-fancybox="gallery" href="<?=HTACCESS_URL?>assets/img/property/property-4.jpg"><img src="<?=HTACCESS_URL?>assets/img/property/property-1.jpg" alt="" title="" class="img-fluid"></a></div>
          <div class="properties-name">
            <div class="float-left">
              <div class="for-sell">for SELL</div>
              <span class="montserrat font-semibold text-blue font-18">₹ 2.2 Cr</span></div>
