...
$var_extra = 'commercial-property/&sort='.$sortval.'&state='.$state.'&city='.$cityUrl.'&locationname='.$locationnameUrl.'&property_type='.$property_typeUrl.'&bedrooms='.$bedroomsUrl.'&budget_min='.$budget_minUrl.'&budget_max='.$budget_maxUrl;
        ...
        <div class="tab-content">
          <div class="dropdown">
            <div id="tab1" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade show active">
              <form action="<?=HTACCESS_URL?>commercialpropertyController.php" method="post" autocomplete="off" class="">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 wow fadeIn">
        ...
        <div class="properties-div">
          ...
          <div class="properties-name">
            ...
            <div class="clearfix"></div>
            <h3 class="font-18 font-semibold"> <a href="<?=HTACCESS_URL?>commercial-property-detail/<?=$dbProperty[$i]['id']?>/<?=$propertyName?>/">
            ...
            <div class="clearfix"></div>
            <a href="<?=HTACCESS_URL?>commercial-property-detail/<?=$dbProperty[$i]['id']?>/<?=$propertyName?>/" class="btn btn-more mb-2"> More Details</a>
            <?php if(!isset($_SESSION['user']['is_login'])) {?>
...
//alert(1111);
    ...
    $.ajax({
        url: "<?=HTACCESS_URL?>commercialpropertyController.php?mode=property_contact",
        data:form_data,
		cache:false,
		async:false,
...
function getOtp(MobileNo){
	...
	//itemCodes = utf8_encode(itemCode);
	 ...
	 $.ajax({
			url:'<?=HTACCESS_URL?>commercialpropertyController.php?mode=get_otp',
