...
$dbObj->dbQuery = "update ".PREFIX."com_property set hit='".$hits."' where id='".$id."'";
...
$dbObj->dbQuery="select * from ".PREFIX."com_property_detail where property_id='".$dbProperty[0]['id']."'";
...
$dbObj->dbQuery="select * from ".PREFIX."com_property_images where property_id='".$dbProperty[0]['id']."' and status='1' order by display_order";
              ...
              <div class="mt-3 mb-3"> 
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 mt-3 col-6">
                    ...
                    <div class="residential montserrat">For Commercial Use</div>
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped mb-0">
                  ...
                  <tr>
                    ...
                    <td><p class="font-bold m-0 font-14 pl-2">Sq. Feet Area</p></td>
                  ...
                  <tr>
                    ...
                    <td><p class="font-bold m-0 font-14 pl-2">No of Work Stations</p></td>
                  ...
                  <tr>
                    ...
                    <td><p class="font-bold m-0 font-14 pl-2">No of Cabins</p></td>
                  ...
                  <tr>
                    ...
                    <td><p class="font-bold m-0 font-14 pl-2">Lease Period</p></td>
...
<?php if(!empty($dbPropertyDetail[0]['main_charges'])){?>
              ...
              <table class="table table-bordered table-striped mb-0">
                ...
                <tr>
                  ...
                  <td><?php if(empty($dbPropertyDetail[0]['pricerequest'])){?><?=$dbPropertyDetail[0]['expected_rent']?>
                    <?=$dbPropertyDetail[0]['expected_rent_unit']?>  <?php  } else {?> Price on request <?php }?></td>
        ...
        <div class="mobile-section">
          ...
          <div>
                ...
                <table class="table table-bordered table-striped mb-0">
                  ...
                  <tr>
                    ...
                    <td class="font-14"><?=$dbPropertyDetail[0]['water_supply']?>
                      ...
                      <? if(!empty($dbPropertyDetail[0]['water_timing'])){?>
            ...
            <?php /*?><div class="position-relative mb-5">
        ...
        <div id="div2">
          ...
          <div class="row mt-3 mb-4 btn-css-3">
            ...
            <?php /*?><div class="col-md-6 col-6 mb-2 pl-1 bt-css ">
      ...
      <div class="col-lg-4 wow fadeInRight">
        ...
        <div class="right-box">
          ...
          <div class="row m-0">
            ...
            <?php /*?><div class="col-6 text-center">
              ...
              <div class="themebg box2">
                ...
                <a data-toggle="modal" data-target="#myModal" style="cursor:pointer"><i class="d-block"> <img src="<?=HTACCESS_URL?>assets/img/download.png"></i>
