...
<div class="center-section-in">
  <div class="container">
    <h2 class="font-30 text-uppercase text-center font-extrabold header-border"> Review 
    <span class="themecolor">us</span> </h2>
    <div class="careers">
      <?php if(!empty($msg)) { ?>
      <center>
        <p style="color:#F00">
      ...
      <div id="thank-you-popup" style="display:none;width:100%;max-width:660px;">
        <div class="right-section form-sec">
            <div>
              ...
              <p class="text-center mb-0">Thank You For Your Review</p>
