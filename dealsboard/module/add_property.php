                  ...
                  <div id="collapseFour" class="card-body collapse font-13" data-parent="#accordion">
                    ...
                    <?php $pro_curr_status = $dbProperty_detail[0]['pro_curr_status'] ?? "";?>
                      ...
                      <div class="col-md-4">
                        ...
                        <?php if(!empty($dbProperty_detail[0]['kitchen_detail'])){?>
                        <select id="example-getting-started" multiple="multiple" name="kitchen_detail[]" class="mdb-select form-control btn-default">
                          <?php 
								$kitch = $dbProperty_detail[0]['kitchen_detail'] ?? "";
						 		$kitchen=explode(',', $kitch);
							?>
                          <option value="Sink" <?=(in_array('Sink',$kitchen))?'selected':''?>> Sink</option>
                          <option value="Platform" <?=(in_array('Platform',$kitchen))?'selected':''?>> Platform</option>
                          <option value="Loft" <?=(in_array('Loft',$kitchen))?'selected':''?>> Loft</option>
                          <option value="Wash Area" <?=(in_array('Wash Area',$kitchen))?'selected':''?>> Wash Area</option>
                          <option value="Store Room" <?=(in_array('Store Room',$kitchen))?'selected':''?>> Store Room</option>
                        </select>
                        <?php }else{?>
                        <select id="example-getting-started" multiple="multiple" name="kitchen_detail[]" class="mdb-select form-control btn-default">
                          ...
                          <option value="Wash Area">Wash Area</option>
                      ...
                      <div class="col-md-4">
                        <h6>Gas supply line availability</h6>
                        <select class="form-control" name="data[gas_supply]" id="gas_supply">
                          <option value="">Select</option>
                          <option value="Yes" <?=($gas_supply=='Yes')?'selected':''?>> Yes</option>
                          <option value="No" <?=($gas_supply=='No')?'selected':''?>> No</option>
                        </select>
                        <br>
                        <br>
                      </div>
              ...
              <div class="col-md-12">
                <div class="card"> <a class="card-header collapsed card-title" data-toggle="collapse" data-parent="#accordion5" href="#collapseFive">Furniture Detail <i class="fa accrd-controller fa-caret-down pull-right"></i></a>
                  <div id="collapseFive" class="card-body collapse font-13" data-parent="#accordion">
                    <div class="row">
                    <?php $wardrobe = $dbProperty_detail[0]['wardrobe'] ?? "";?>
                      <div class="col-md-4">
                        <h6>Wardrobe</h6>
                        <select class="form-control" name="data[wardrobe]">
                          <option value="">Select</option>
                          <?php for($i=1;$i<11;$i++){?>
                          <option value="<?=$i?>" <?=($wardrobe==$i)?'selected':''?>>
                          <?=$i?>
                          </option>
                          <?php }?>
                        </select>
                      ...
                      <?php $beds = $dbProperty_detail[0]['beds'] ?? "";?>
                      <div class="col-md-4">
                        <h6>Beds</h6>
                      ...
                      <?php $fans = $dbProperty_detail[0]['fans'] ?? "";?>
                      <div class="col-md-4">
                        <h6>Fans</h6>
                        <select class="form-control" name="data[fans]">
                          <option value="">Select</option>
                          <?php for($i=1;$i<11;$i++){?>
                          <option value="<?=$i?>" <?=($fans==$i)?'selected':''?>>
                          <?=$i?>
                          </option>
                          <?php }?>
                        </select>
                      ...
                      <?php $light = $dbProperty_detail[0]['light'] ?? "";?>
                      <div class="col-md-4">
                        <h6>Light</h6>
                        <select class="form-control" name="data[light]">
                          <option value="">Select</option>
                          <?php for($i=1;$i<11;$i++){?>
                          <option value="<?=$i?>" <?=($light==$i)?'selected':''?>>
                          <?=$i?>
                          </option>
                          <?php }?>
                        </select>
                  ...
                  <div id="collapseEight" class="card-body collapse font-13" data-parent="#accordion">
                    <div class="row">
                      <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" name="offer_price" id="offer_price" placeholder="Offer Price (In Rupees) For Sell" value="<?=$dbProperty_detail[0]['offer_price'] ?? ""?>">
...
//document.getElementById('parking_detail').addEventListener('change', function() {
//	var parkingDropdown = document.getElementById('parking_detail');
//    var parkingDetailDropdown = document.getElementById('parkingdetail');
//	if(parkingDropdown.value == 'Reserved') {
//          
//         parkingDetailDropdown.style.display = 'block';
//         parkingDetailDropdown.value = '';  
//     } else {
//         
//         parkingDetailDropdown.style.display = 'none';
//         parkingDetailDropdown.value = '';  
//     }
//});
</script>