...
$dbObj->dbQuery="select * from ".PREFIX."free_advice"; // for listing of records
...
$dbAdvice = $dbObj->SelectQuery();
$cntH = count((array)$dbAdvice);
?>
<style>
#contentLeft {
	width:100%;
            ...
            <div class="card-body">
              ...
              <div class="table-responsive mt-10">
                <form action="contentController.php" method="post" id="hostForm">
                  <input type="hidden" name="mode" value="delete_free_advice"/>
                  <input type="hidden" name="counter" id="counter" value="<?=count($dbAdvice)?>" />
                    ...
                    <tbody id="changes">
                      ...
                      <tr>
                        ...
                        <span id="<?=$dbSubscribe[$i]['id']?>">
                          <input type="checkbox" id="c<?=$i?>" name="id[]" value="<?=$dbAdvice[$i]['id']?>">
                          </span></td>
                        <td width="10%"><?=$dbAdvice[$i]['service']?></td>
                        <td width="10%"><?=$dbAdvice[$i]['name']?></td>
                        <td width="10%"><?=$dbAdvice[$i]['email']?></td>
                        <td width="10%"><?=$dbAdvice[$i]['mobile_no']?></td>
                        <td width="10%"><?=$dbAdvice[$i]['city']?></td>
                        <td width="10%"><?=$dbAdvice[$i]['message']?></td>
                        <?php
							$datef = $dbAdvice[$i]['current_datetime'];
