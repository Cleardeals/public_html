  ...
  <div class="page-wrapper"> 
    ...
    <div class="container-fluid"> 
      ...
      <form action="blogController.php" method="post" id="accForm" enctype="multipart/form-data">
        <input type="hidden" name="mode" value="add_update_blog_header_category"/> 
            ...
            <div class="row accordion" id="accordion1">
              <div class="col-md-12">
                <div class="card"> <a class="card-header collapsed in card-title" data-toggle="collapse" href="#collapseOne">
                 Add/Update Header Category <i class="fa accrd-controller fa-caret-down pull-right"></i></a>
                  <div id="collapseOne" class="card-body collapse show border font-13" data-parent="#accordion1">
                    <?php for($i=0;$i<$cntH;$i++){?>
                      <div class="row"> 
                        <div class="col-md-6">
                          <h6>Category Name</h6>
                          <input class="form-control" type="text" name="info[category][]" id="name" placeholder="Category Name" value="<?=$dbCategory[$i]['name']?>">
                          <br>
                          <br>
                        </div>  
                      </div> 
