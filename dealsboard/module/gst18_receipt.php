...
$var_extra = "gst18_receipt"; // to enable page link
...
$dbObj->dbQuery="select * from ".PREFIX."gst18_receipt"; // for listing of records
if(!empty($cnum)){
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php } ?>
              <h3>Manage 18% Gst Receipt</h3>
              <div class="row">
                <div class="text-left col-md-6"> <a href="index.php?mo=add_gst18_receipt" class="btn waves-effect waves-light btn-rounded btn-primary"> Generate 18% Gst Receipt</a></div>
              </div>
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr> 
                        ...
                        <td width="10%"><?=$dbReceipt[$i]['invoice_no']?></td>
                        <td width="10%"><?=date('d-m-Y',strtotime($dbReceipt[$i]['invoice_date']))?></td>
                        <!--<td width="10%">
						<?=$dbReceipt[$i]['c_num']?></td>-->
                        <td width="10%"><?=$dbReceipt[$i]['name']?></td>
                        ...
                        <td width="5%"><a href="index.php?mo=add_gst18_receipt&id=<?=$dbReceipt[$i]['id']?>" class="text-primary"><i class="fa fa-edit"></i></a>
                          <?php if($_SESSION['srgit_cms_admin_id']=='1'){
						// echo '1111111111';
						 ?>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="gst18ReceiptController.php?mode=delete_receipt&id=<?=$dbReceipt[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a>
                          <?php }?></td>
                      </tr>
                      <?php }?>
                    </tbody>
...
function receipt_status(id,value,is_check){
	...
	$.ajax({
		url:'gstReceiptController.php?mode=receipt_status',
