...
$var_extra = "com_arrange_site_visit"; // to enable page link
...
$dbObj->dbQuery="select * from ".PREFIX."com_site_visit"; // for listing of records
            ...
            <div class="card-body">
              ...
              <div class="table-responsive mt-10">
                <form action="contentController.php" method="post" id="hostForm">
                  ...
                  <input type="hidden" name="counter" id="counter" value="<?=count($dbSiteVisit)?>" />
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
					  ...
					  ?>
                      <tr>
                        <td class="text-center" width="5%"><span id="<?=$dbSiteVisit[$i]['id']?>">
