...
$dbObj->dbQuery="select * from ".PREFIX."appointment"; // for listing of records
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php } ?>
              <h3>Appointment for Home/Villa/Bunglow</h3>
              <div class="table-responsive mt-10">
                <form action="contentController.php" method="post" id="hostForm">
                  <input type="hidden" name="mode" value="delete_appointment"/>
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr>
                        <td class="text-center" width="5%"><span id="<?=$dbAppointment[$i]['id']?>">
                          <input type="checkbox" id="c<?=$i?>" name="id[]" value="<?=$dbAppointment[$i]['id']?>">
                          </span></td>
                        <td width="10%"><?=date('d/m/Y', strtotime($dbAppointment[$i]['current_date']))?></td>
                        <td width="10%"><?=$dbAppointment[$i]['name']?></td>
                        <td width="10%"><?=$dbAppointment[$i]['email']?></td>
                        <td width="10%"><?=$dbAppointment[$i]['mobile_no']?></td>
                        <td width="10%"><?=$dbAppointment[$i]['purpose_of_valuation']?></td>
                        <?php
							$datef = $dbAppointment[$i]['app_date'];
