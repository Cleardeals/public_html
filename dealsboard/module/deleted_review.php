...
$dbObj->dbQuery="select * from ".PREFIX."review where admin_del='1'"; // for listing of records
if(empty($view)){
              ...
              <div class="table-responsive mt-10">
                <form action="reviewController.php" method="post" id="hostForm">
                  ...
                  <table id="myTable" class="display table table-hover table-striped table-bordered" width="100%">
                    <thead>
                      <tr>
                        <!--<th class="text-center" width="3%"> <input type="checkbox" id="select" onClick="return selectAll()"/></th>-->
                        <th width="8%">Name</th>
                        <th width="8%">Email</th>
                    ...
                    <tbody id="changes">
                      ...
                      <tr>
                       <!-- <td class="text-center" width="3%">
                          <input type="checkbox" id="c<?=$i?>" name="id[]" value="<?=$dbReview[$i]['id']?>">
                          </td>-->
                        <td id="move" width="8%"><span id="<?=$dbReview[$i]['id']?>"><?=$dbReview[$i]['name']?></span></td>
                        ...
                        <td width="5%"><a href="reviewController.php?mode=review_restore&id=<?=$dbReview[$i]['id']?>" class="text-primary">Restore</a></td>
                        <td width="5%"><a href="reviewController.php?mode=delete_deleted_review&id=<?=$dbReview[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
