...
$dbObj->dbQuery="select * from ".PREFIX."blog where admin_del='1'"; // for listing of records
if(empty($view)){
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr> 
                        ...
                        <td id="move" width="10%"><span id="<?=$dbBlog[$i]['id']?>">
                          <?=$dbBlog[$i]['title']?>
                          </span></td>
                        <td id="move" width="10%"><img src="../cms_images/blog/thumb/<?=$dbBlog[$i]['image']?>" width="100"></td>
                        <!--<td width="5%"><?=$dbBlog[$i]['display_order']?></td>-->
                        <td width="5%"><a href="blogController.php?mode=blog_restore&id=<?=$dbBlog[$i]['id']?>" class="text-primary">Restore</a></td>
                        <td width="5%"><a href="blogController.php?mode=delete_deleted_blog&id=<?=$dbBlog[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
