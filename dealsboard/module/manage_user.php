...
$dbObj->dbQuery="select * from ".PREFIX."user_detail where user_type='Buyer'"; // for listing of records
if(empty($view)){
                ...
                <form action="userController.php" method="post" id="hostForm">
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr>
                        ...
                        <td width="5%"><a href="index.php?mo=progress_report&user_id=<?=$dbUser[$i]['id']?>"> Progress Report</a></td>
                  ...
                  <table id="testTable" class="display nowrap table table-hover table-striped table-bordered" width="100%" style="display:none;">
                    ...
                    <tbody id="changes">
					  ...
					  $state = $dbObj->sc_mysql_escape($dbUser[$i]['state'] ?? "");
					  $dbObj->dbQuery="select * from ".PREFIX."state where id='".$state."'"; // for listing of records
