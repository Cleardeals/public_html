...
$dbObj->dbQuery="select * from ".PREFIX."property where admin_del='1'"; // for listing of records
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td width="5%"><a href="propertyController.php?mode=delete_deleted_property&id=<?=$dbProperty[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
