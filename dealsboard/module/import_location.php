  ...
  <div class="page-wrapper"> 
    ...
    <div class="container-fluid"> 
      ...
      <form action="contentController.php" method="post" id="accForm" enctype="multipart/form-data">
        <input type="hidden" name="mode" value="import_location" />
        <input type="hidden" name="id" value="<?=$id?>" />
        <div class="row" id="main">
          <div class="col-md-12" id="content">
            <div class="row accordion" id="accordion1">
              <div class="col-md-12">
                <div class="card"> <a class="card-header collapsed in card-title" data-toggle="collapse" href="#collapseOne"> Import Location <i class="fa accrd-controller fa-caret-down pull-right"></i></a>
                  <div id="collapseOne" class="card-body collapse show border font-13" data-parent="#accordion1">
                    ...
                    <br>
                    <br>
                    <h6>Import location excelsheet of predefine format</h6>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div  class="text-left col-md-6"> <a href="index.php?mo=add_update_location" class="btn waves-effect waves-light btn-rounded btn-primary">Add New</a> </div>
                <div class="col-md-6 text-right"></div>
              </div>
              <div class="table-responsive mt-10">
                <form action="contentController.php" method="post" id="hostForm">
                  <input type="hidden" name="mode" value="delete_location"/>
                  <input type="hidden" name="counter" id="counter" value="<?=count($dbLocation)?>" />
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr> 
                        <!--<td class="text-center" width="5%"><span id="<?=$dbLocation[$i]['id']?>">
                          <input type="checkbox" id="c<?=$i?>" name="id[]" value="<?=$dbLocation[$i]['id']?>">
                          </span></td>-->
                        <td width="10%"><?=$dbLocation[$i]['location']?></td>
                        <td width="10%"><?=$dbLocation[$i]['city']?></td>
                        <td width="8%"><a href="index.php?mo=add_update_location&id=<?=$dbLocation[$i]['id']?>" class="text-primary"><i class="fa fa-edit"></i></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="contentController.php?mode=delete_location&id=<?=$dbLocation[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
