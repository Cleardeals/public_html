...
$dbObj->dbQuery="select * from ".PREFIX."sold_property"; // for listing of records
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php } ?>
              <h3>Manage Sold Property</h3>
              <div class="row">
                <div class="text-left col-md-6"> <a href="index.php?mo=add_sold_property" class="btn waves-effect waves-light btn-rounded btn-primary"> Add New</a></div>
              </div>
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody id="changes">
                      ...
                      <tr> 
                        ...
                        <td id="move" width="10%"><span id="<?=$dbProperty[$i]['id']?>">
                          <?=$dbProperty[$i]['property_name']?>
                          </span></td>
                        <td width="10%"><img src="../cms_images/sold-property/thumb/<?=$dbProperty[$i]['image']?>" width="100" height="100"></td>
                        ...
                        <td width="5%"><a href="index.php?mo=add_sold_property&id=<?=$dbProperty[$i]['id']?>" class="text-primary"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="soldPropertyController.php?mode=delete_single_property&id=<?=$dbProperty[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
...
function property_status(id,value,is_check){
	...
	$.ajax({
		url:'soldPropertyController.php?mode=property_status',
