...
$dbObj->dbQuery="select * from ".PREFIX."com_property where admin_del='1'"; // for listing of records
                  ...
                  <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td width="10%"><span id="<?=$dbProperty[$i]['id']?>">
                          <?=$dbProperty[$i]['property_name']?>
                          </span></td>
                        <td width="10%"><?=$dbProperty[$i]['property_type']?></td>
                        <td width="10%"><?=$dbProperty[$i]['for_property']?></td>
                        
                        <!-- <td width="10%"><a href="index.php?mo=property_images&property_id=<?=$dbProperty[$i]['id']?>">Manage Images</a></td>-->
                        
                        <td width="5%"><a href="propertyController.php?mode=property_restore&id=<?=$dbProperty[$i]['id']?>" class="text-primary">Restore</a></td>
                        
                        <!--<td width="5%"><?=$dbProperty[$i]['display_order']?></td>-->
                        
                        <td width="5%"><a href="compropertyController.php?mode=delete_deleted_com_property&id=<?=$dbProperty[$i]['id']?>" class="text-primary" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                    <tfoot>
