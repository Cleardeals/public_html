...
$dbObj->dbQuery="select * from ".PREFIX."book_free_valuation_content where id='".$id."'";
...
<div id="main-wrapper"> 
  ...
  <div class="page-wrapper"> 
    ...
    <div class="container-fluid"> 
      <!-- Start Page Content --> 
      <!-- ============================================================== -->
      <form action="contentController.php" method="post" id="accForm" enctype="multipart/form-data" autocomplete="off">
        <input type="hidden" name="mode" value="add_update_book_free_valuation" />
          ...
          <div class="col-md-9" id="content">
            <div class="row accordion" id="accordion1">
              <div class="col-md-12">
                ...
                Add/Update Book Free valuation content <i class="fa accrd-controller fa-caret-down pull-right"></i></a>
