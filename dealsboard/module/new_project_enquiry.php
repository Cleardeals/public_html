...
$dbObj->dbQuery="select * from ".PREFIX."new_project_enquiry"; // for listing of records
...
$dbProjectEnq = $dbObj->SelectQuery();
$cntH = count((array)$dbProjectEnq);
?>
<style>
#contentLeft {
	width: 100%;
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php } ?>
              <h3>New Project Promotion Enquiry</h3>
              <div class="table-responsive mt-10">
                <form action="contentController.php" method="post" id="hostForm">
                  <input type="hidden" name="mode" value="delete_peoject_enq"/>
                  <input type="hidden" name="counter" id="counter" value="<?=count($dbProjectEnq)?>" />
                    ...
                    <tbody id="changes">
                      ...
                      <tr>
                        <td class="text-center" width="5%"><span id="<?=$dbSubscribe[$i]['id']?>">
                          <input type="checkbox" id="c<?=$i?>" name="id[]" value="<?=$dbProjectEnq[$i]['id']?>">
                          </span></td>
                        <td width="10%"><?=$dbProjectEnq[$i]['name']?></td>
                        <td width="10%"><?=$dbProjectEnq[$i]['company_name']?></td>
                        <td width="10%"><?=$dbProjectEnq[$i]['email']?></td>
                        <td width="10%"><?=$dbProjectEnq[$i]['contact_no']?></td>
                        <?php
							$datef = $dbProjectEnq[$i]['current_datetime'];
