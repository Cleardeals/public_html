    ...
    <div class="row2">
      ...
      <div class="top-part2 position-relative">
        ...
        class="btn text-white call-bt"><i class="fa fa-whatsapp"></i> 9723992200</a>--> 
          ...
          <?php }?>
          <button type="button" id="sidebarCollapse" class="btn btn-info font-14 font-bold themebg text-uppercase border-0"> <i class="fa fa-align-left"></i> <span>Menu2</span> </button>
        </div>
      </div>
    </div>
  </div>
