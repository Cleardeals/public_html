...
<div class="row mt-3">
  ...
  <div class="newsletter-bg col-md-12 col-6  mb-3 text-center">
    ...
    <form action="<?=HTACCESS_URL?>commentController.php" method="post" id="subsForm"  autocomplete="off">
      ...
      <div class="form-group">
        <select class="form-control font-13" aria-label="Default select example" name="city" required="required">
      ...
      <div class="form-group">
        <select class="form-control font-13" aria-label="Default select example" name="service" required="required">
